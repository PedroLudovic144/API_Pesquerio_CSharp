...
namespace PesqueiroNetApi.Migrations
{
    ...
    [Migration("20250929225529_AddProdutoPesqueiroRelation")]
    partial class AddProdutoPesqueiroRelation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PesqueiroNetApi.Entities.PeixeCapturado", b =>
                {
                    b.Property<int>("IdPeixeCapturado")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdPeixeCapturado"));

                    b.Property<DateOnly>("DataPeixeCapturado")
                        .HasColumnType("date");
                    ...
                    b.HasKey("IdPeixeCapturado");

                    b.HasIndex("EspecieIdEspecie");

                    b.ToTable("PeixesCapturados");
                });

            modelBuilder.Entity("PesqueiroNetApi.Entities.PeixeCliente", b =>
                {
                    b.Property<int>("IdCliente")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("PeixeCapturadoIdPeixeCapturado")
                        .HasColumnType("int");

                    b.HasKey("IdCliente", "IdPeixeCapturado");

                    b.HasIndex("ClienteIdCliente");

                    b.HasIndex("PeixeCapturadoIdPeixeCapturado");

                    b.ToTable("PeixesClientes");
                });
            ...
            modelBuilder.Entity("PesqueiroNetApi.Entities.PeixeCliente", b =>
                {
                    b.HasOne("PesqueiroNetApi.Entities.Cliente", "Cliente")
                        .WithMany("PeixeClientes")
                        .HasForeignKey("ClienteIdCliente");

                    b.HasOne("PesqueiroNetApi.Entities.PeixeCapturado", "PeixeCapturado")
                        .WithMany("PeixeClientes")
                        .HasForeignKey("PeixeCapturadoIdPeixeCapturado");

                    b.Navigation("Cliente");

                    b.Navigation("PeixeCapturado");
                });
